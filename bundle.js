...
/***/ function(module, exports, __webpack_require__) {
	...
	var contApi = __webpack_require__(8);
	var contUi = __webpack_require__(9);
	...
	var addHandlers = function addHandlers() {
	  ...
	  $('#update-contact').on('submit', function (event) {
	    event.preventDefault();
	    var id = $(".update-contact-btn").attr("data-contact-id");
	    var data = getFormFields(this);
	  ...
	  $('.table').on('click', '.update-contact', function (event) {
	    event.preventDefault();
	    var id = $(event.target).attr("data-contact-id");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var notifyUser = function notifyUser(success, failure) {
...
/***/ function(module, exports) {
	...
	var app = {
	  api: 'https://murmuring-reef-45689.herokuapp.com'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createContact = function createContact(success, failure, data) {
	  $.ajax({
	    method: "POST",
	...
	var getContacts = function getContacts(success, failure) {
	  $.ajax({
	    method: "GET",
	    url: app.api + '/contacts',
	    dataType: 'json',
	...
	var updateContact = function updateContact(success, failure, data, contact_id) {
	  //if(!app.user) bad;
	  $.ajax({
	    method: "PATCH",
	...
	var deleteContact = function deleteContact(success, failure, contact_id) {
	  $.ajax({
	    url: app.api + '/contacts/' + contact_id,
	    method: 'DELETE',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayContacts = function displayContacts(contacts) {
	  var contactListingTemplate = __webpack_require__(10);
	  $('.table').empty();
	...
	var dateAdd = function dateAdd(date, interval, units) {
	...
	var formatDate = function formatDate(contact) {
	  console.log(contact.last_contacted);

	  //user.reminder = data.reminder
	  var oldDate = new Date(contact.last_contacted);

	  var reminder = dateAdd(oldDate, 'month', contact.reminder);

	  var today = new Date();

	  if (reminder <= today) {
	    $('.reminder').fadeIn(1200);
	    $('.reminder').append("Find some time to catch up with " + contact.first_name + " " + contact.last_name + ", it has been over " + contact.reminder + " " + "month(s), since your last contact!");
	...
	var showContactsSuccess = function showContactsSuccess(data) {
	...
	module.exports = {
	  ...
	  showContactsSuccess: showContactsSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <tr>\n    <td>"
	    ...
	    + "</td>\n    <td>"
	    + alias2(alias1((depth0 != null ? depth0.occupation : depth0), depth0))
	    + "</td>\n    <td>"
	    + alias2(alias1((depth0 != null ? depth0.professional_relationship : depth0), depth0))
	    + "</td>\n    <td>"
	    + alias2(alias1((depth0 != null ? depth0.last_contacted : depth0), depth0))
	    + "</td>\n    <td>"
	    + alias2(alias1((depth0 != null ? depth0.fact : depth0), depth0))
	    + "</td>\n    <td>"
	    + alias2(alias1((depth0 != null ? depth0.reminder : depth0), depth0))
	    + "</td>\n    <td><button type=\"button\" class=\"btn btn-primary update-contact\" data-contact-id=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" data-toggle=\"modal\" data-target=\"#update-contact-modal\">Update</button></td>\n    <td><button type=\"button\" class=\"btn btn-danger delete-contact\" data-contact-id=\""
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" data-toggle=\"modal\" data-target=\"#delete-contact-modal\">Delete</button></td>\n  </tr>\n";
